      ...
      <main className="flex-1">
        ...
        <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-10 right-[15%] w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse [animation-delay:2s]" />
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={`/${locale}/profiles`}>
                <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 border-0 font-bold text-white">
